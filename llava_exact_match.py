...
TRAIN_HASH_FILES_DIR = os.path.expanduser("~/hash_files_llava")  # Directory where train hashes are saved
TEST_HASH_FILES_DIR = os.path.expanduser("~/test_hash_files_v2")  # Directory where test hashes are saved
RESULTS_DIR = os.path.expanduser("~/match_results_exact_llava")  # Directory to save the results
IMAGE_PATHS_PICKLE = os.path.expanduser("~/image_paths_llava.pkl")  # Path to the training image paths
